 ...
 */
	...
	'''«longAttributeName(name)» = «value.compile»;''' /*DONE*/
	...
	'''«variable.compile».«longAttributeName(memberName)»''' /*DONE*/
	...
	def dispatch CharSequence compile(And it) '''and(«left.compile», «right.compile»)''' /*DONE*/
	def dispatch CharSequence compile(Less it) '''lt(«left.compile», «right.compile»)''' /*DONE*/
	def dispatch CharSequence compile(LessOrEquals it) '''le(«left.compile», «right.compile»)''' /*DONE*/
	def dispatch CharSequence compile(Complement it) '''not(«expr.compile»)''' /*DONE*/
	def dispatch CharSequence compile(Touches it) '''touches(«left.compile», «right.compile»)''' /*DONE*/
	...
	def dispatch CharSequence compile(Minus it) '''(«left.compile» - «right.compile»)''' /*DONE*/
	def dispatch CharSequence compile(Divide it) '''(«left.compile» / «right.compile»)''' /*DONE*/
	def dispatch CharSequence compile(Times it) '''(«left.compile» * «right.compile»)''' /*DONE*/
